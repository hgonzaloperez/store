...
_Generated: 2026-04-03T02:42:50.880Z_
...
Workspace `mcp.json` _(folder: store)_

- **c:\Users\Gonzalo Pérez\Angular\store\.vscode\mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\Gonzalo Pérez\AppData\Roaming\Code\User\mcp.json** — _File missing_
